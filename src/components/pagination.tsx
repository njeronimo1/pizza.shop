        ...
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6 lg:gap-8">
                ...
                <div className="flex items-center gap-2">
                    <Button onClick={() => {onPageChange(0)}} variant="outline" size="xs" disabled={pageIndex === 0}>
                    ...
                    <Button onClick={() => {onPageChange(pageIndex + 1)}} variant="outline" size="xs" disabled={pages <= pageIndex + 1}>
                        <ChevronRight className="h-4 w-4" />
                        <span className="sr-only">Proxima página</span>
                    </Button>
                    
                    <Button onClick={() => {onPageChange(pages - 1)}} variant="outline" size="xs" disabled={pages <= pageIndex + 1}>
